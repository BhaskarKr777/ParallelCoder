...
function App() {
  ...
  if(!username){
    return(
      <main className="h-screen w-screen bg-gray-950 flex gap-4 p-3 items-center justify-center">
      <form 
      onSubmit={handleJoin}
  ...
  return (
  <main className="h-screen w-screen bg-gray-950 flex gap-4 p-3">
    <aside className="h-full w-1/4 bg-amber-50 rounded-lg">
      <h2 className="text-2xl font-bold text-gray-950 p-4 border-b border-gray-300">Users</h2>
      <ul className="p-4">
